...
### AIM
To write a Python program to create a class Employee with a parameterized constructor and a display function that prints all the attributes of the employee.
### ALGORITHM
...
class Employee:
    ...
    def display(self):
        print("Id value :", self.a)
        print("Name value :", self.b)
        print("Age value :", self.c)
        print("Gender value :", self.d)
        print("DOJ value :", self.e)
        print("DOB value :", self.f)

id = eval(input("Enter ID: "))
name = input("Enter Name: ")
age = input("Enter Age: ")
gender = input("Enter Gender: ")
doj = eval(input("Enter DOJ (Year): "))
dob = eval(input("Enter DOB (Year): "))

obj = Employee(id, name, age, gender, doj, dob)
obj.display()

```
### OUTPUT
![image](https://github.com/user-attachments/assets/afb28cb0-a6f5-4956-b143-a3cd5835d98c)


### RESULT
Thus, the Python program to create a class Employee with a parameterized constructor and a display method to print employee details was implemented and executed successfully.
